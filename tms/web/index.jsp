  ...
  <nav class="navbar navbar-inverse">
    <div class="container-fluid">
      <div class="navbar-header">
        <a class="navbar-brand" title="logoTitle" href="#">管理系统首页</a>
      </div>
  ...
  <div class="pageContainer">
    ...
    <div class="pageSidebar" style="font-weight: bold">
      <ul class="nav nav-stacked nav-pills">
        <li role="presentation">
          <a href="#" <%--target="mainFrame"--%>>用户信息管理</a>
        </li>
        <li role="presentation">
          <a href="#" <%--target="mainFrame"--%> style="background-color: #5bc0de;">教师信息管理</a>
        </li>
        <li role="presentation">
          <a href="#" <%--target="mainFrame"--%>>成绩管理</a>
        </li>
        <li role="presentation">
          <a href="#" <%--target="mainFrame"--%> style="background-color: #5bc0de;">授课信息管理</a>
        </li>
        <li role="presentation">
          <a href="<%=contextPath%>/api/studentServlet?method=findAllByPage" <%--target="mainFrame"--%>>学生信息管理</a>
        </li>
        <li role="presentation">
          <a href="<%=contextPath%>/jsp/student/search.jsp" <%--target="mainFrame"--%> style="background-color: #5bc0de;">学生选课管理</a>
        </li>
        <li role="presentation" >
          <a href="<%=contextPath%>/api/courseServlet?method=findAllByPage" <%--target="mainFrame"--%>>课程信息管理</a>
        </li>
        <%--<li class="dropdown">
